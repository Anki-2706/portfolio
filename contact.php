<?php
// contact.php - PDO handler with small hardening: honeypot, rate-limit, logging.
//
// Place this file at project root (same folder as index.php).
// Make sure PHP sessions are enabled. Create a writable folder "logs/" for error logs
// (or change $logFile path below).
