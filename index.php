...
<body>
  ...
  <main>
    <!-- show message after redirect from contact.php -->
<?php if(isset($_GET['sent']) && $_GET['sent']==1): ?>
  <div class="wrap" style="margin-top:18px;">
    <div style="background:#ecfdf5;border:1px solid #bbf7d0;padding:12px;border-radius:8px;color:#065f46;">
      Message sent successfully — thank you!
    </div>
  </div>
<?php elseif(isset($_GET['sent']) && $_GET['sent']==0): ?>
  <div class="wrap" style="margin-top:18px;">
    <div style="background:#fff1f2;border:1px solid #fecaca;padding:12px;border-radius:8px;color:#7f1d1d;">
...
<?php endif; ?>
    ...
    <section class="hero" id="home">
      <div class="wrap hero-grid">
        <div class="hero-left">
          <p class="eyebrow">WEB DEVELOPERS</p>
          <h1 class="hero-title">ANKITH</h1>
        ...
        <div class="hero-right">
          <div class="profile-wrap">
            <img src="assets/images/hero.jpg" alt="Profile" class="profile-img" />
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="projects-grid">
        <article class="project-card">
          <div class="project-body">
            ...
            <p class="project-desc">A responsive single-page portfolio built with HTML, CSS and vanilla JavaScript. Includes a PHP + MySQL contact form for local testing.</p>
          </div>
        </article>
      </div>
    </section>
  ...
  <div class="certificates-grid">
    ...
    <article class="certificate-card">
      <div class="certificate-body">
       ...
       <a href="http://localhost/portfolio/assets/Certificates/data-mining.pdf" target="_blank" class="cert-btn">View Certificate</a>
      </div>
    </article>
...
<a href="http://localhost/portfolio/assets/Certificates/ethical.pdf" target="_blank" class="cert-btn">View Certificate</a>
      ...
      <div class="contact-grid-new">
        <div class="contact-card-big">
          ...
          <div class="card-ctas">
            ...
            <a class="btn btn-outline small" href="assets/anki.pdf" download>Download CV</a>
          </div>
        </div>

        <form class="contact-form-new" method="post" action="contact.php">
  ...
  <!-- JS: place at end so DOM is ready -->
